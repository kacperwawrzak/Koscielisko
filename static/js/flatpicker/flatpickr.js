...
function FlatpickrInstance(element, config) {
  ...
  */
	...
	function positionCalendar() {
		...
		var top = window.pageYOffset + inputBounds.top + (!showOnTop ? positionElement.offsetHeight : -calendarHeight);
        

        toggleClass(self.calendarContainer, "mdc-elevation--z4", !showOnTop);
        toggleClass(self.calendarContainer, "mdc-elevation--z3", showOnTop);
...
flatpickr.l10ns = {
	...
	pl: {
		weekdays: {
			shorthand: ["Nd", "Pn", "Wt", "Ĺr", "Czw", "Pt", "So"],
			longhand: ["Niedziela", "PoniedziaĹek", "Wtorek", "Ĺroda", "Czwartek", "PiÄtek", "Sobota"]
		},
		months: {
			shorthand: ["Sty", "Lut", "Mar", "Kwi", "Maj", "Cze", "Lip", "Sie", "Wrz", "PaĹş", "Lis", "Gru"],
			longhand: ["StyczeĹ", "Luty", "Marzec", "KwiecieĹ", "Maj", "Czerwiec", "Lipiec", "SierpieĹ", "WrzesieĹ", "PaĹşdziernik", "Listopad", "GrudzieĹ"]
		},
		daysInMonth: [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31],
		firstDayOfWeek: 1,
		ordinal: function ordinal(nth) {
...
flatpickr.l10ns.default = Object.create(flatpickr.l10ns.pl);
